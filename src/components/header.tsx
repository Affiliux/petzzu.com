...
export function Header() {
  ...
  return (
    <div className='absolute top-0 left-0 w-full py-[8px] bg-black border-b border-neutral-800/60 z-50'>
      <div className='container flex flex-row items-center justify-between'>
        <div className='flex flex-row items-center gap-12'>
          ...
          <div className='lg:flex flex-row items-center gap-6 hidden'>
            <Link
              href='#plans'
              className='text-neutral-300 text-sm hover:text-neutral-50 hover:underline cursor-pointer'
              scroll
            >
            ...
            <div className='flex flex-row items-center gap-2 opacity-55'>
              <Link href='https://affiliux.com' className='text-neutral-300 text-sm cursor-pointer'>
        ...
        <div className='relative flex items-center gap-2'>
          ...
          <div className='flex flex-row items-center gap-1 md:gap-4 lg:hidden'>
            <div className='relative group'>
              ...
              <div className='origin-top-left lg:origin-top-right min-w-72 mt-0.5 z-[99999] border border-neutral-800 absolute right-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-300 rounded-lg shadow-lg bg-black ring-1 ring-black ring-opacity-5'>
                <div className='py-1 grid grid-cols-1 gap-2' role='none'>
                  <Link
                    href='#plans'
                    className={
                      'text-gray-300 px-6 py-2 text-start items-center inline-flex hover:bg-neutral-800 rounded-l'
                    }
                  >
                  ...
                  <Link
                    ...
                    className={
                      'text-gray-300 px-6 py-2 pb-4 text-start items-center opacity-55 inline-flex hover:bg-neutral-800 rounded-l'
                    }
                  >
