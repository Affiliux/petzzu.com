...
export function HeaderStep({ theme, activeStep, steps, setStep }: HeaderStepProps) {
  ...
  return (
    <div className='py-4'>
      ...
      <div className='mt-8'>
        <h2 className='bg-clip-text text-neutral-900 bg-gradient-to-b from-neutral-200 to-white text-3xl lg:text-4xl font-sans py-2 relative z-20 font-bold tracking-tight'>
