  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className='w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-theme-200 px-8 py-6 md:w-[450px]'
            style={{
              background: 'linear-gradient(180deg, var(--theme-900), var(--theme-950)',
            }}
            key={item.name}
          >
            <blockquote>
