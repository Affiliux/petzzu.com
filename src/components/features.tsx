...
export function Features() {
  ...
  const features = [
    ...
    },
    {
      ...
      className: 'col-span-1 lg:col-span-3 lg:border-r border-neutral-800 hidden lg:block',
    },
    {
...
export const SkeletonOne = () => {
  ...
  return (
    <div className='relative flex p-4 px-2 gap-10 h-full'>
      <div className='mx-auto shadow-2xl group h-full'>
        <div className='flex h-full flex-col space-y-2'>
          {/* TODO */}
          <div className='grid grid-cols-2 lg:grid-cols-3 gap-2 mt-8'>
            <div className='group/card w-full lg:min-w-[8rem] h-[8rem] hover:shadow-2xl hover:shadow-emerald-500/[0.1] flex flex-col lg:bg-neutral-800/50 bg-neutral-800/80 backdrop-blur-xl items-center justify-center rounded-xl p-4'>
              <h1 className={`${lora.className} text-2xl text-center font-bold text-white`}>
                {years < 10 ? 0 : ''}
                {years}
              </h1>
              <p className={`${lora.className} text-lg text-center text-neutral-300`}>{t('themes.default.years')}</p>
            </div>
            <div className='group/card w-full lg:min-w-[8rem] h-[8rem] hover:shadow-2xl hover:shadow-emerald-500/[0.1] flex flex-col lg:bg-neutral-800/50 bg-neutral-800/80 backdrop-blur-xl items-center justify-center rounded-xl p-4'>
              <h1 className={`${lora.className} text-2xl text-center font-bold text-white`}>
                {months < 10 ? 0 : ''}
              ...
              <p className={`${lora.className} text-lg text-center text-neutral-300`}>{t('themes.default.months')}</p>
            </div>
            <div className='group/card w-full lg:min-w-[8rem] h-[8rem] hover:shadow-2xl hover:shadow-emerald-500/[0.1] flex flex-col lg:bg-neutral-800/50 bg-neutral-800/80 backdrop-blur-xl items-center justify-center rounded-xl p-4'>
              <h1 className={`${lora.className} text-2xl text-center font-bold text-white`}>
                {days < 10 ? 0 : ''}
              ...
              <p className={`${lora.className} text-lg text-center text-neutral-300`}>{t('themes.default.days')}</p>
            </div>
            <div className='group/card w-full lg:min-w-[8rem] h-[8rem] hover:shadow-2xl hover:shadow-emerald-500/[0.1] flex flex-col lg:bg-neutral-800/50 bg-neutral-800/80 backdrop-blur-xl items-center justify-center rounded-xl p-4'>
              <h1 className={`${lora.className} text-2xl text-center font-bold text-white`}>
                {hours < 10 ? 0 : ''}
              ...
              <p className={`${lora.className} text-lg text-center text-neutral-300`}>{t('themes.default.hours')}</p>
            </div>
            <div className='group/card w-full lg:min-w-[8rem] h-[8rem] hover:shadow-2xl hover:shadow-emerald-500/[0.1] flex flex-col lg:bg-neutral-800/50 bg-neutral-800/80 backdrop-blur-xl items-center justify-center rounded-xl p-4'>
              <h1 className={`${lora.className} text-2xl text-center font-bold text-white`}>
                {minutes < 10 ? 0 : ''}
              ...
              <p className={`${lora.className} text-lg text-center text-neutral-300`}>{t('themes.default.minutes')}</p>
            </div>
            <div className='group/card w-full lg:min-w-[8rem] h-[8rem] hover:shadow-2xl hover:shadow-emerald-500/[0.1] flex flex-col lg:bg-neutral-800/50 bg-neutral-800/80 backdrop-blur-xl items-center justify-center rounded-xl p-4'>
              <h1 className={`${lora.className} text-2xl text-center font-bold text-white`}>
                {seconds < 10 ? 0 : ''}
              ...
              <p className={`${lora.className} text-lg text-center text-neutral-300`}>{t('themes.default.seconds')}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-row -ml-4'>
        {animations1.map((animation, idx) => (
          <motion.div
            ...
            whileTap='whileTap'
            className='rounded-xl h-40 w-48 md:h-52 md:w-48 -mr-4 mt-4 p-1 bg-neutral-800 border flex-shrink-0 overflow-hidden'
          >
            <LazyLoadVideo
              src={animation}
              type='video/webm'
