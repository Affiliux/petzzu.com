...
export const PreviewNetflix = ({ couple, song, medias }: PreviewNetflixProps) => {
  ...
  useEffect(() => {
    if (medias && medias.length > 0) set_selected_image(medias[0])
    else set_selected_image({} as MediaPreProps)
  }, [medias])

  return (
    <div className='relative no-scrollbar overflow-x-hidden w-full min-h-screen lg:min-h-[85vh] lg:h-[85vh] lg:max-h-[85vh] rounded-lg bg-[#141414] shadow-lg shadow-black'>
      ...
      <div className='flex items-center justify-between px-6 pt-4 pb-3 bg-[#141414] w-full absolute top-10 z-10'>
        <div className='flex items-center justify-center w-full space-x-4'>
          <img src='/images/netflix-logo.png' alt='Netflix Logo' className='h-8' />
        </div>
      </div>

      <section
        className='relative h-[85vh] flex bg-cover bg-center'
        style={
          !!selected_image.url
      ...
      >
        ...
        <div className='relative z-10 p-6 md:p-12 pt-[40vh] lg:pt-[38vh]'>
          <h1 className={`${dancing.className} text-4xl md:text-5xl font-bold mb-4`}>{couple?.coupleName}</h1>
          ...
          {couple?.coupleName && couple?.message && (
            <>
              ...
              <div className='flex flex-row items-center gap-2 my-6'>
                ...
                <p className='font-bold text-lg'>{t('themes.netflix.top-10')}</p>
              </div>
          ...
          {!!medias.length && (
            <div className='py-14'>
              ...
              <div className='grid grid-cols-2 lg:grid-cols-3 w-full gap-y-4 py-4'>
